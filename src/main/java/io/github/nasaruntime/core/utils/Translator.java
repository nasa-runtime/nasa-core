...
import io.github.nasaruntime.core.interceptor.LangHolder;
...
public abstract class Translator {
    ...
    /**
     * 业务作用：把文案翻译成当前线程语言。翻译结果带缓存，避免同一文案反复调用远端翻译。
     *
     * @param word 见上述说明
     * 返回: 翻译后的文案；无可用翻译时原样返回入参。
     */
