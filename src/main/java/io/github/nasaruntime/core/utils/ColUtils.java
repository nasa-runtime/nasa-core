...
public abstract class ColUtils {
    ...
    /**
     * 业务作用：业务作用：把集合先按条件筛选、再按映射函数转换，最后收集到调用方指定类型的容器中，一次遍历完成筛选、转换与收集三步。
     *
     * 集合转集合
     *
     * @param col       集合
    ...
    /**
     * 业务作用：业务作用：把集合转成映射，键与值分别由映射函数产出。键冲突时由冲突函数决定取舍，不指定则后者覆盖前者；容器类型由构造器决定。
     *
     * 集合转Map
     *
     * @param col         集合
    ...
    /**
     * 业务作用：业务作用：把集合转成 HashMap，键与值分别由映射函数产出。
     *
     * 集合转 HashMap
     *
     * @param col         集合
    ...
    /**
     * 业务作用：业务作用：把集合转成 LinkedHashMap，保留元素的原始顺序。
     *
     * 集合转 LinkedHashMap
     *
     * @param col         集合
    ...
    /**
     * 业务作用：业务作用：把集合转成 ConcurrentHashMap，供后续并发读写。
     *
    ...
    /**
     * 业务作用：业务作用：按分组函数对集合分组，组内结果再由收集器归约，映射容器类型由工厂决定。
     *
     * 集合分组
     *
     * @param col        集合
