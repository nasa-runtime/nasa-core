...
import io.github.nasaruntime.core.annotation.TPS;
import io.github.nasaruntime.core.permission.Permissions;
...
public class AppCollector {
    ...
    /**
     * 业务作用：按给定参数构造 AppCollector 实例。
     *
     * @param restfulRouter 见上述说明
     * @param interfaceRouter 见上述说明
     * @param obj 目标对象
     * @param method 方法
     * 返回: 构造完成后可直接使用的实例。
     */
